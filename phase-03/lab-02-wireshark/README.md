...
**What I captured:**
- DNS query packet — "Standard query A google.com" — my VM asking for the IPv4 address
- DNS response packet — "Standard query response A google.com" — DNS server returning the IP
- Matched transaction IDs between query and response — confirmed they're the same lookup
- Expanded the Answers section in the packet detail pane — confirmed A record IP matched nslookup terminal output
**Screenshot:**
