...
# NOTE: Standard_D2s_v7 requires a Gen2 image (see sku below).
# If you change this size, confirm generation compatibility first —
# this exact mismatch caused a real deploy failure (see README Troubleshooting Log #8).
